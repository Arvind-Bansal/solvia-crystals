    ...
    <>
      ...
      <main className="pt-40 pb-24 bg-[#F8F5EF] min-h-screen text-[#262626]">
        <div className="container mx-auto px-6 max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-serif text-[#262626] mb-4 font-medium">Returns & Exchanges</h1>
          ...
          <section className="mb-16">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-serif text-[#262626] font-medium">30-Day Return Policy</h2>
            </div>
          ...
          <section className="mb-16">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-serif text-[#262626] font-medium">Exchanges</h2>
            </div>
            <p className="text-[#262626]/80 leading-relaxed mb-4">
          ...
          <section className="mb-16">
            <h2 className="text-2xl font-serif text-[#262626] mb-6 font-medium">How to Return</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={item.step} className="flex gap-4 p-5 bg-white border border-[#262626]/10 rounded-sm shadow-xs">
                  ...
                  <p className="text-[#262626]/80 text-sm leading-relaxed">{item.text}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-serif text-[#262626] font-medium">Non-Returnable Items</h2>
            </div>
            <ul className="list-disc list-inside text-[#262626]/80 space-y-2 text-sm">
