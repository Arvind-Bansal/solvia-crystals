    ...
    <>
      ...
      <main className="pt-40 pb-24 bg-[#F8F5EF] min-h-screen text-[#262626]">
        <div className="container mx-auto px-6 max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-serif text-[#262626] mb-4 font-medium">Shipping</h1>
          <p className="text-[#262626]/70 mb-12 text-lg">
          ...
          <section className="mb-16">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-serif text-[#262626] font-medium">Processing Time</h2>
            </div>
          ...
          <section className="mb-16">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-serif text-[#262626] font-medium">Shipping Methods</h2>
            </div>
            <div className="space-y-4">
              {shippingMethods.map((method) => (
                <div key={method.label} className="flex items-center justify-between p-5 bg-white border border-[#262626]/10 rounded-sm shadow-xs">
                  <div>
                    <p className="text-[#262626] font-medium">{method.label}</p>
                    <p className="text-sm text-[#262626]/60">{method.time}</p>
                    {method.note && <p className="text-xs text-brand-gold mt-1">{method.note}</p>}
                  </div>
                  <span className="text-[#262626] font-medium">{formatPrice(method.cost)}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="mb-16">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-serif text-[#262626] font-medium">Delivery Across India</h2>
            </div>
            <p className="text-[#262626]/80 leading-relaxed mb-4">
          ...
          <section>
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-serif text-[#262626] font-medium">Packaging</h2>
            </div>
            <p className="text-[#262626]/80 leading-relaxed">
